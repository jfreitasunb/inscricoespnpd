    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="idiomas btn-toolbar">
        <div class="btn-group-justified">
          <a href="#" class="btn btn-primary button">Português</a>
          <a href="#" class="btn btn-primary button">English</a>
          <a href="#" class="btn btn-primary button">Español</a>
        </div>  
      </div>
    </div>
  </div>
    ...
    <form role="form">
      <fieldset>
        <div class="row">
          ...
          <a href="#" class="btn btn-link">Esqueceu</a>
        </span>  
          </div>
